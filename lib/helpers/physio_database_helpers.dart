...
class PhysioDatabaseHelpers {
  ...
  static get_doctors(context) async {
    List<DoctorModel> docs =
        Provider.of<AppData>(context, listen: false).all_doctors;
    ...
    await FirebaseFirestore.instance
      ...
      Provider.of<AppData>(context, listen: false).update_all_doctors(docs);
    });
  ...
  // add history
  static Future<bool> add_history(
  ...
  static Future<bool> set_health_data(
    ...
    try {
      await PhysioDatabaseHelpers.pt_client_ref
          .doc(client_key)
