...
class ClientHealthRegistrationPage extends StatefulWidget {
  final bool register;
  final HealthClientModel client;
  final HealthModel health;
  const ClientHealthRegistrationPage({
    super.key,
    this.register = false,
  ...
  @override
  State<ClientHealthRegistrationPage> createState() =>
      _ClientHealthRegistrationPageState();
}

class _ClientHealthRegistrationPageState
    extends State<ClientHealthRegistrationPage> {
  ...
  HealthModel? health;
  HealthClientModel? client;

  String get_date() {
    return DateFormat('dd_MM_yyyy').format(DateTime.now());
  }
  ...
  void dispose() {
    ...
    sugar_level_controller.dispose();
      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              Container(width: 250, child: submit_button()),
              if (widget.register) SizedBox(width: 40),
              if (widget.register) Container(width: 150, child: skip_button())
            ],
          ),
        ),
      ],
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // form
          (widget.health.data_type == 'basic')
              ? basic_left_form()
              : comprehensive_left_form(),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          (widget.health.data_type == 'basic')
              ? basic_right_form()
              : comprehensive_right_form(),
        ],
      ),
    );
  }

  Widget basic_left_form() {
    return Expanded(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    ...
                    child: Text_field(
                      label: 'Sugar Level',
                      controller: sugar_level_controller,
                    ),
                  ),
                ],
              ),
  ...
  Widget comprehensive_left_form() {
    return Expanded(
      child: SingleChildScrollView(
        child: Column(
          children: [
  ...
  Widget comprehensive_right_form() {
    return Expanded(
      child: SingleChildScrollView(
        child: Column(
          children: [
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Text(
              'Fitness and Wellness Objectives',
              style: headingStyle,
            ),
          ),
    ...
    return InkWell(
      onTap: () async {
        RenewalModel newDet = RenewalModel(
          ...
          name: client!.name,
          sub_plan: client!.hmo == 'No HMO' ? '' : 'HMO Plan',
          pt_plan: '',
          pt_status: false,
          boxing: false,
          sub_type: 'Individual',
          hmo_name: client!.hmo != 'No HMO' ? client!.hmo : null,
          sub_income: 0,
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(10),
          color: Color.fromARGB(255, 213, 60, 255).withOpacity(0.5),
        ),
        padding: EdgeInsets.symmetric(horizontal: 15, vertical: 10),
        child: Center(
          child: Text(
  ...
  Widget reset_button() {
    return InkWell(
      onTap: () async {
        ...
        ideal_weight_controller = TextEditingController();
  ...
  void update_health_controllers() {
    ...
    sugar_level_controller.text = health!.sugar_level;
  ...
  update_health_details(bool done, {bool skip = false}) async {
    bool blood_sug = fasting_blood_select == 'True' ? true : false;

    HealthModel h_data = HealthModel(
      ...
      sugar_level: sugar_level_controller.text.trim(),
