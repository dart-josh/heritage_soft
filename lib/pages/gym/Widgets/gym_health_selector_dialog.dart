...
class HealthSelectorDialog extends StatelessWidget {
  final List<G_HealthModel> list;
  const HealthSelectorDialog({super.key, required this.list});
                      ...
                      .map(
                        (e) => InkWell(
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: Text(
                                '${e.key != 'Baseline' ? fmt_date(e.key) : 'Baseline'} - (${e.type})',
                                style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 16,
