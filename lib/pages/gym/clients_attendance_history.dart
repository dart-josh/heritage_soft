...
class CAH extends StatefulWidget {
  final At_Date month;
  final CAH_Model client;
  const CAH({super.key, required this.month, required this.client});

  @override
  State<CAH> createState() => _CAHState();
}

class _CAHState extends State<CAH> {
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            ...
            child: Center(
              child: Text(
                '${client!.name}\'s Attendance History',
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          flex: 2,
                          child: Center(
                              child: Text('${capitalize(e.session)} Session',
                                  style: sessionStyle)),
                        ),
