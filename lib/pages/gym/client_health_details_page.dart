...
class ClientHDPage extends StatefulWidget {
  ...
  @override
  State<ClientHDPage> createState() => _ClientHDPageState();
}

class _ClientHDPageState extends State<ClientHDPage> {
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            // pulse rate & blood pressure & sugar level
            Padding(
              padding: EdgeInsets.symmetric(vertical: 8),
              child: Row(
                children: [
