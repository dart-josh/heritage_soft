...
import 'package:heritage_soft/pages/staff/staff_attendance_history.dart';
import 'package:heritage_soft/pages/staff/staff_personal_daily_attendance.dart';
import 'dart:ui' as ui;

import 'package:intl/intl.dart';
import 'package:month_year_picker2/month_year_picker2.dart';

class GSAH extends StatefulWidget {
  const GSAH({super.key});

  @override
  State<GSAH> createState() => _GSAHState();
}

class _GSAHState extends State<GSAH> {
  // Text controller
          ...
          child: Align(
            ...
            child: InkWell(
              onTap: () {
                ...
                // go to staff attendance history
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => SAH(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return InkWell(
                        onTap: () {
                          ...
                          // go to staff personal attendance
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => SPDA(
                                staff: cl_pda,
                                date: date,
                              ),
                            ),
  ...
  // get client details
  get_staffs() async {
    var data = await StaffDatabaseHelpers.get_staff();
