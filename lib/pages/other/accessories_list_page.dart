...
import 'package:heritage_soft/pages/other/add_accessories_dialog.dart';
...
class _AccessoriesListState extends State<AccessoriesList> {
  ...
  Widget build(BuildContext context) {
    accessory_list = Provider.of<AppData>(context).accessories;

    accessory_list.sort((a, b) => a.name.compareTo(b.name));
    ...
    return Scaffold(
      ...
      floatingActionButton: (app_role == 'admin' || app_role == 'ict') ? floating_button() : null,
      backgroundColor: Color.fromARGB(255, 3, 25, 43),
      body: Column(
        children: [
          // search bar
  ...
  Widget item_tile(AccessoryModel accessory) {
    bool warning = accessory.qty <= accessory.limit;
    bool out_of_stock = accessory.qty <= 0;
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Center(
                child: Text(
                  accessory.code.isEmpty
                      ? get_code(accessory.name)
                      : accessory.code,
                  style: TextStyle(
            ...
            Text(
              ...
              style: TextStyle(
                  color: !is_available ? Colors.white38 : Colors.white,
                  fontSize: accessory.name.length > 65 ? 13 : 14),
            ),
