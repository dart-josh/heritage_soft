...
class PhysioPrintPage extends StatefulWidget {
  ...
  const PhysioPrintPage({super.key, this.payment_print, this.session_print});
    ...
    return pw.Padding(
      ...
      child: pw.Column(
        children: [
          ...
          // cost per session
          if (!is_assessment) detail_tile('Cost per Session: ', print.cost_p_session.toString()),

          if (print.amount != 0 && print.amount_b4_discount != print.amount && print.amount_b4_discount != 0)
            pw.SizedBox(height: 2),
          // discount amount
          if (print.amount != 0 && print.amount_b4_discount != print.amount  && print.amount_b4_discount != 0)
            pw.Row(
          ...
          // sessions added
          if (!is_assessment) if (print.session_paid != 0) detail_tile('Sessions Added: ', print.session_paid.toString()),

          if (print.old_float != 0 || print.new_float != 0)
            pw.SizedBox(height: 4),

          // old floating
          if (!is_assessment) if (print.old_float != 0)
            detail_tile('Old Floating: ', print.old_float.toString()),

          // new floating
          if (!is_assessment) if (print.new_float != 0)
